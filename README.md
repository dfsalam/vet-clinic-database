...
**[Vet-clinic-database]** is the initial data structure for a vet clinic.
...
- The project doesn't need installation.

### Usage

To run the project you need to open the SQL shell and copy the queries on the command line.

### Run tests

The project doesn't have tests.
...
Feel free to check the [issues page](https://github.com/dfsalam/vet-clinic-database/issues).
